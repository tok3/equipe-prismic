<section class="full-width-image content-section dark-translucent-bg" >
  <img class="img-full-width" src="<?= $slice->getPrimary()->getImage('image')->getUrl() ?>"/>
</section>
...
<section class="dark-translucent-bg pv-30" style="background-image:url(<?/*= $slice->getPrimary()->getImage('image')->getUrl() */?>);">
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4">
        <div class="pv-30 feature-box text-center object-non-visible animated object-visible fadeInDownSmall" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
      ...
      <div class="col-lg-4">
        <div class="pv-30 feature-box text-center object-non-visible animated object-visible fadeInDownSmall" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
      ...
      <div class="col-lg-4">
        <div class="pv-30 feature-box text-center object-non-visible animated object-visible fadeInDownSmall" data-animation-effect="fadeInDownSmall" data-effect-delay="300">
